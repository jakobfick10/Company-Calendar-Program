...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 22:09:13 2024
...
class employeeDayFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        view_sub = tk.Button(self, wraplength=80, justify="center", text="view subordinate", command=self.controller.get_subordinates)
